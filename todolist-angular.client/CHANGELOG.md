...
- Create Angular project with ng: `ng new todolist-angular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`todolist-angular.client.esproj`).
